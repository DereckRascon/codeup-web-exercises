...
(function () {
    ...
    cheeses.shift(); //shift erases the first cheese in the array.
    ...
    cheeses.pop(); //pop erases the last cheese in the array
    ...
    // We can also use indexOf on arrays!
        ...
        // console.log(cheeses.indexOf("Kraft American Singles")); //indexOf looks for an identical value in the array.
    ...
    let names = csvNames.split(",");//this will be useful for an upcoming assessment.

     console.log(names);//this will be useful for an upcoming assessment.

    csvNames = names.reverse().join(",");//this will be useful for an upcoming assessment.

    // console.log(csvNames);

    // Secret time: Let's talk about joining two arrays together...

    let alphaTeam = ["David", "Jay", "Javier", "Justin", "Dorian", "Douglas", "Fernando"];
    let goldTeam = ["Kenneth", "Sam", "Zach", "Casey", "Vivian", "Jason", "Codey The Duck"];
